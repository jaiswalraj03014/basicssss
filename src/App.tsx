...
const handleContactSubmit = async (e: React.FormEvent) => {
  ...
  const skillsData = 
   [
    ...
    { name: 'Pytorch', category: 'ML', logo: 'https://cdn.simpleicons.org/pytorch/ffffff' },
    ...
    { name: 'XGBoost', category: 'ML', logo: 'https://cdn.simpleicons.org/python/ffffff' },
    ...
    { name: 'Autogen', category: 'Agentic fw', logo: 'https://raw.githubusercontent.com/simple-icons/simple-icons/develop/icons/microsoft.svg?color=ffffff'},
